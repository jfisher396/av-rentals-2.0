...
const API = {
  ...
  userLogin: function (loginData) {
    return axios.post(`${urlPrefix}/api/users/login`, loginData, {
      withCredentials: true,
    });
  },

  getCurrentUser: function () {
    return axios.get(`${urlPrefix}/api/users/readsessions`, {
      withCredentials: true,
    });
  },

  getCurrentOrders: function () {
    return axios.get(`${urlPrefix}/api/users/currentuserdata`, {
      withCredentials: true,
    });
  },
  userLogout: function () {
    return axios.get(`${urlPrefix}/api/users/logout`, {
      withCredentials: true,
    });
  },
};
